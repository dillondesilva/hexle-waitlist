      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div
            ...
            data-aos-delay={600}
          >
            <div className="relative transition-opacity ease-in duration-1200 opacity-100 rounded-2xl px-5 py-3 before:pointer-events-none before:absolute before:-inset-5 before:border-y  after:absolute after:-inset-5 after:-z-10">
              {/* <img src="images/hexleuidesigns.png" className="rounded-2xl shadow-2xl"></img> */}
              <video src="hexlevid1.mp4" className="rounded-2xl shadow-2xl" autoPlay muted={true} loop={true}/>
